<%-- 
    Document   : registro
    Created on : 12/11/2015, 11:41:52 AM
    Author     : angel
--%>
...
<html>
<head>
<title>Deportes 3000 - Registro</title>
    	      ...
    	      <h4 class="title">Crear cuenta</h4>
    		   <form class="Form-Registro" action="Registro" method="post">
    			 <div class="col_1_of_2 span_1_of_2">
                             <div>
                                 <input type="text" value="" name="Nombre" placeholder="Nombre"></div>
                             <div><input type="text" name="e-mail" value="" placeholder="E-mail"></div>
                             <div class="comments-area">
                                 <p class="code">Contraseña</p>
                                 <input type="password" value="" name="pass">
                             </div>
		    	 </div>
		    	  <div class="col_1_of_2 span_1_of_2">	
                              <div><input type="text" value="" name="direccion" placeholder="Direccion"></div>
		    		<div><select id="country" name="country" onchange="change_country(this.value)" class="frm-field required">
		            <option value="null">Selecciones su pais</option>         
		            ...
		            <option value="SN">Senegal</option>
                              ...
                              <div><input type="text" value="" name="ciudad" placeholder="Ciudad"></div>
		          </div>
                       <button class="grey" type="submit">Crear cuenta</button>
		         <p class="terms">Al crear una cuenta, usted acepta los <a href="#">Terminos y Condiciones</a> de Deportes 3000.</p>
		         <div class="clear"></div>
		    </form>
    	  </div> 
        </div>
